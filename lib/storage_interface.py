...
def save_photo_instagram(photos, foursquare_venue_id, instagram_venue_id, crawl_user_id):
    ...
    for photo in photos:
        ...
        cursor.execute("REPLACE INTO venue_photo_instagram"+str(crawl_user_id)+" (foursquare_venue_id, instagram_venue_id, id, filter, tags, comments, likes_count, link, username, profile_picture, standard_resolution, created_time) values(%s" + ",%s"*11 + ")",(foursquare_venue_id,instagram_venue_id, _id, _filter, _tags, _comments, _likes_count, _link, _username, _profile_picture, _standard_resolution, _created_time) )
...
def save_venue_tip(tips, venue_id, crawl_user_id):
    ...
    for tip in tips['tips'].get('items', None):
        ...
        cursor.execute("REPLACE INTO venue_tips"+str(crawl_user_id)+" (venue_id, id, createdAt, text, likesCount, user_id, user_firstName, user_lastName, user_photo, user_gender, user_homeCity, user_tips) values (%s"+",%s"*11+")", (venue_id, id, createdAt, text, likesCount, user_id, user_firstName, user_lastName, user_photo, user_gender, user_homeCity, user_tips) )
